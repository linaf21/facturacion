package com.vortexbird.facturacion.utility;
...
public class Utilities {
	 ...
	 * @author Frank Edward Daza Gonzï¿½lez
	 * @date Nov 1, 2017
	 * @param lblName
	 * @param locale
	 * @return
	...
	/**
	 * Funcï¿½ï¿½n para redondear un nï¿½mero double a los decimales que le ingresen
	 * 
	...
	/**
	 * Funciï¿½n para obtener el nï¿½mero que sea mï¿½ltiplo de "multiploDe" y mayor
	 * que "mayorQue"
	 *
	 * @author Camilo Delgado
	 * @version Mar 24, 2018
